...
function ProductManagement() {
  ...
  const handleEdit = (product) => {
    ...
    setFormData({
      ...
      mainImage: null,
      existingImages: processedExistingImages,
      newImages: [],
      offer: product.offer || '',
      sizes: product.sizes || [],
...
function ProductManagement() {
  ...
  const handleEdit = (product) => {
    setFormData({
      ...
      description: product.description,
      mainImage: null,
      existingImages: product.images ? product.images.map(img => `https://backend-ps76.onrender.com${img}`) : [],
      newImages: [],
      offer: product.offer || '',
      sizes: product.sizes || [],
      isActive: product.isActive,
          ...
          <form onSubmit={handleSubmit} className="product-form">
            ...
            <div className="form-group">
              ...
              {formData.mainImage && (
                <div className="image-preview">
                  <img
                    ...
                    onError={(e) => {
                      console.log('Main image load failed:', e.target.src);
                      e.target.src = 'https://backend-ps76.onrender.com/upload/default-product.jpg';
              ...
              {editingProductId && !formData.mainImage && formData.existingImages.length > 0 && (
                <div className="image-preview">
                  <img
                    src={formData.existingImages[0] || 'https://backend-ps76.onrender.com/uploads/default-product.jpg'}
                    alt="Current Main"
                    onError={(e) => {
                      console.log('Current main image load failed:', e.target.src);
