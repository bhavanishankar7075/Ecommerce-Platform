...
// Configure CORS
 app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:5002', 'http://localhost:5003', 'http://localhost:5004','https://backend-ps76.onrender.com','https://frontend-8uy4.onrender.com','https://admin-frontend-o3u7.onrender.com'],
